...
namespace Unheard.ViewModels
{
    public class AboutPageViewModel : ViewModelBase
    {
        ...
        public AboutPageViewModel(INavigationService navigationService, IContentPackage contentPackage) : base(navigationService)
        {
        ...
        {
            CopyEmbeddedContent(_basePath, "Unheard.htmlzipfile.content.zip", "content.zip");
